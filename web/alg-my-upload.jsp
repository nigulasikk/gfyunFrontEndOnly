    ...
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-md-10">
            ...
            <div class="row shop-nav">
                ...
                <div class="col-md-4">
                    <a href="/alg.jsp">
                        <div class="well bg-blue shop-nav-item ">
                ...
                <div class="col-md-4">
                    <a href="/alg-my-upload.jsp">
                        <div class="well bg-black shop-nav-item shop-nav-item-active">
            ...
            <section class="application-center">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div id="newApplicationBtn" class="application application-single-height application-bg-black">
                            <span class="glyphicon glyphicon-cloud-upload application-small-font"></span>
                            <h4>我要上传</h4>
