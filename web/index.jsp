...
<head>
    ...
    <link rel="stylesheet" href="/css/myHdd/index.css">
</head>
...
<div class="container">
    ...
    <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="col-xs-12 col-sm-10">
            ...
            <div>
                <button type="button" class="btn btn-default btn-sm" id="goBackBtn">返回</button>
            ...
            <tr>
                ...
                <td class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <small><a href="index-detail-ftp.jsp">ftp上传</a></small>
                        </div>
            ...
            <tr>
                ...
                <td class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <small><a href="index-detail-share.jsp">来自分享</a></small>
                        </div>
            ...
            <tr>
                ...
                <td class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <small><a href="index-detail-cloud.jsp">云算法生成数据</a></small>
                        </div>
            ...
            <tr>
                ...
                <td class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <small><a href="index-detail-deal.jsp">来自订单</a></small>
                        </div>
            ...
            <tr>
                ...
                <td class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <small><a href="index-detail-area.jsp">区域订阅</a></small>
                        </div>
            ...
            <tr>
                ...
                <td class="col-md-11">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="image-box">
                                <img src="/images/folder.png" width="80" height="70">
                            </div>

                        </div>
                        <div class="col-md-9">
                            <small><a href="index-detail-self-define.jsp">自定义创建文件名</a></small>
                        </div>
                ...
                <td class="col-md-11">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                <div class="col-md-12">
                                    <small>文件名称:GF1_WFV1_W57.8_S4.0_20130102_L1A0000001879.tar.gz</small>
                                </div>

                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <small>文件来源：来自订单</small>
                                </div>
                                <div class="col-md-8">
                                    <small>订单名称：北京雾霾订单</small>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4"><small>卫星名称:GF1</small></div>
